...
- *Os dados deste estudo não estão disponíveis*.
...
1. **Semântica:** `scripts/study1_semantics/CircumplexClean.Rmd`
2. **Fisiologia:** `scripts/study3_physiologyEMO2018_FG.Rmd`
